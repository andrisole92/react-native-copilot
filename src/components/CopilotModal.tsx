...
import { ARROW_SIZE, MARGIN, STEP_NUMBER_DIAMETER, STEP_NUMBER_RADIUS, styles } from "./style"
...
export const CopilotModal = forwardRef<CopilotModalHandle, Props>(function CopilotModal(
  {
  ...
  const handleLayoutChange = ({ nativeEvent: { layout: newLayout } }: LayoutChangeEvent) => {
  ...
  function renderTooltip() {
    ...
    return (
      <>
        ...
        {!!arrowSize && <Animated.View key="arrow" style={[styles.arrow, arrowStyles]} />}
        <Animated.View key="tooltip" style={[styles.tooltip, tooltipStyles, tooltipStyle]}>
